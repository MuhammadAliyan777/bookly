...
if(isset($_POST['send'])){
    ...
    if(mysqli_num_rows($res) > 0){
       ...
       $add_product_query = "INSERT INTO `contest`(user_name,user_email,user_number,image,story_name,story_category) VALUES('$name','$email','$number', '$file','$story_name','$story_type')" or die('query failed');
